...
impl Settings {
    pub fn new(prep_seconds: i64, work_seconds: i64, rest_seconds: i64) -> Settings {
        Settings {
    ...
    pub fn set_from_cmdline(&mut self) -> Result<(), ParseError> {
        ...
        opts.optopt("p",
                    "prep",
                    "set the preparation time to NUMBER seconds",
                    "NUMBER");
        opts.optopt("w",
                    "work",
                    "set the workout time to NUMBER seconds",
                    "NUMBER");
    ...
    fn set_arg(&mut self, matches: &getopts::Matches, arg: &str) -> Result<(), ParseError> {
